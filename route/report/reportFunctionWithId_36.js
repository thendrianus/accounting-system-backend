...
module.exports = {
    generateReport: (req, callback) => {
        ...
        let purchase_receive_id = report_data.data.purchase_receive_id;
        ...
        req.getConnection(function (err, conn) {
            ...
            var myfireStr = `
                ...
                WHERE t1.purchase_receive_id = ${purchase_receive_id}
            `;
            ...
            var query = conn.query(myfireStr, function (err, rows) {
                ...
                var myfireStr = `
                    SELECT
                        ...
                        t3.warehouse
                    FROM
                    ${CUS_DB}.purchase_receive_detail t1
