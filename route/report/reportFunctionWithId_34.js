...
module.exports = {
    generateReport: (req, callback) => {
        ...
        let purchase_order_id = report_data.data.purchase_order_id;
        ...
        req.getConnection(function (err, conn) {
            ...
            var myfireStr = `
                ...
                WHERE t1.purchase_order_id = ${purchase_order_id}
            `;
            ...
            var query = conn.query(myfireStr, function (err, rows) {
                ...
                var myfireStr = `
                    SELECT
                        ...
                        t4.name AS "tax"
                    FROM
                    ${CUS_DB}.purchase_order_detail t1
