...
module.exports = {
    generateReport: (req, callback) => {
        ...
        let purchase_request_id = report_data.data.purchase_request_id;
        ...
        req.getConnection(function (err, conn) {
            ...
            var myfireStr = `
                ...
                WHERE t1.purchase_request_id = ${purchase_request_id}
            `;
            ...
            var query = conn.query(myfireStr, function (err, rows) {
                ...
                var myfireStr = `
                    SELECT
                        ...
                        t3.warehouse
                    FROM
                    ${CUS_DB}.purchase_request_detail t1
