...
module.exports = {
    generateReport: (req, callback) => {
        ...
        let purchase_quotation_id = report_data.data.purchase_quotation_id;
        ...
        req.getConnection(function (err, conn) {
            ...
            var myfireStr = `
                ...
                WHERE t1.purchase_quotation_id = ${purchase_quotation_id}
            `;
            ...
            var query = conn.query(myfireStr, function (err, rows) {
                ...
                var myfireStr = `
                    SELECT
                        ...
                        t4.name AS "tax"
                    FROM
                    ${CUS_DB}.purchase_quotation_detail t1
