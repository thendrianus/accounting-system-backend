...
module.exports = {
    generateReport: (req, callback) => {
        ...
        let sale_quotation_id = report_data.data.sale_quotation_id;
        ...
        req.getConnection(function (err, conn) {
            ...
            var myfireStr = `
                ...
                WHERE t1.sale_quotation_id = ${sale_quotation_id}
            `;
            ...
            var query = conn.query(myfireStr, function (err, rows) {
                ...
                var myfireStr = `
                    SELECT
                        ...
                        t4.name AS "tax"
                    FROM
                    ${CUS_DB}.sale_quotation_detail t1
